...
cov_set = [];
test_result = [];
% calculate the UCL of T2 statistic
p = 3;
m = 150;
...
for i=1:115
    ...
    elseif i>=10 && i <100 
        ...
        [r,g,b]=haar2_wavelet(sprintf('image_part_%d.jpg',i));
    end
    X_bar_set = [X_bar_set;r,g,b];
...
% calculate the mean value of sample
...
title("Phase I image Hotelling T2 statistic")
xlabel("image number")
% ylabel("log2(T2 statistic)")
 ylabel("T2 statistic")
 
 % save the in-control parameter in t2_150_1.mat file
save('t2_150_1.mat','X_double_bar','covariance');
